(module
 ...
 (data (i32.const 112) "\0e\00\00\00\01\00\00\00\01\00\00\00\0e\00\00\00t\00y\00p\00e\00.\00t\00s\00")
 (table $0 1 funcref)
 ...
 (global $~lib/heap/__heap_base i32 (i32.const 144))
 ...
 (func $~lib/array/Array<u32>#constructor (; 6 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else   
 ...
 (func $start:type (; 7 ;) (type $FUNCSIG$v)
